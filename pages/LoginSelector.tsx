...
const LoginSelector: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-deep text-white flex flex-col items-center justify-center px-6 relative overflow-hidden">
      ...
      {/* Background glow */}
      <div className="absolute -left-40 top-1/3 w-[500px] h-[500px] bg-brand-neon/20 blur-[120px]" />
      <div className="absolute -right-40 top-1/4 w-[500px] h-[500px] bg-purple-600/20 blur-[120px]" />
      ...
      {/* Cards */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl z-10">
        
        {/* TEAM */}
        <button
          onClick={() => navigate("/login/team")}
          className="group relative rounded-2xl overflow-hidden border border-white/10 bg-white/[0.02] backdrop-blur-xl p-10 text-left transition-all hover:border-brand-neon/50 hover:bg-white/[0.04]"
        >
          {/* Background image */}
          <div
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-5xl font-black italic mb-6">TEAM</h2>

            <p className="text-white/70 text-lg leading-relaxed max-w-md">
              Gestión completa de equipos, categorías, jugadores, torneos,
              logística y pagos. Herramientas profesionales para clubes.
            </p>
        ...
        <button
          ...
          className="group relative rounded-2xl overflow-hidden border border-white/10 bg-white/[0.02] backdrop-blur-xl p-10 text-left transition-all hover:border-purple-400/50 hover:bg-white/[0.04]"
        >
          {/* Background image */}
          <div
            className="absolute inset-0 opacity-20 group-hover:opacity-30 transition-opacity"
          ...
          <div className="relative z-10">
            ...
            <h2 className="text-5xl font-black italic mb-6">FAMILY</h2>

            <p className="text-white/70 text-lg leading-relaxed max-w-md">
              Información clara del torneo, viajes, documentación y estado
              de pagos del jugador. Todo en un dashboard sencillo y seguro.
            </p>
      ...
      <footer className="mt-14 text-xs text-white/30 z-10">
